...
public class DamageIndicator : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        transform.localScale = Vector3.Lerp(Vector3.zero, Vector3.one, Mathf.Sin(timer / lifetime) / 10);
    }

    public void SetDamageText(int damage)
    {
        int damaged = damage - (damage * 2);
        text.text = damaged.ToString();
    }
}